...
| E   | Test coverage   | sonnet | Missing React Testing Library + Vitest cases for changed behavior; untested error and empty states; whether a bug fix has a regression test that fails without the fix; queries that assert implementation detail instead of user-visible behavior                                                                                                                                                                                                                                                                                                                                |
