        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6 mb-6">
          <div className="flex gap-3">
            ...
            <button
              ...
              className="bg-primary hover-bg-primary-dark !text-on-primary px-6 py-3 rounded-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
              {isAddingTodo ? (
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                    filter === filterOption
                      ...
                      : "bg-surface-muted text-secondary hover-bg-muted"
                  }`}
                >
