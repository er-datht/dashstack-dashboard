        ...
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg
                     bg-white dark:bg-[#0f1015] text-gray-800 dark:text-gray-100
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                  filter === filterOption
                    ...
                    : "bg-gray-100 dark:bg-[#0f1015] text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"
                }`}
              >
          ...
          <>
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              {paginatedTodos.map((todo) => (
                <div
                  key={todo.id}
                  className="p-4 hover:bg-gray-50 dark:hover:bg-[#0f1015] transition-colors group"
                >
                  <div className="flex items-center gap-3">
                    {/* Complete Checkbox */}
                    <button
                    ...
                    <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        ...
                        aria-label={
                          todo.starred ? t("actions.unstar") : t("actions.star")
                        }
                      >
                        <Star
                          className={`w-5 h-5 ${
