...
export default function TeamCard({
  ...
  const showFallback = !member.avatar || imgError;
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col items-center gap-2">
        <p
          className="text-primary font-bold text-base truncate w-full text-center"
          title={member.name}
        >
          {member.name}
        </p>
        <p
          className="text-secondary text-sm truncate w-full text-center"
          title={member.email}
        >
          {member.email}
        </p>
