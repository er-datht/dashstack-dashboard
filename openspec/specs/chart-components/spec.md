...
## Purpose
Defines the recharts-based dashboard chart components (RevenueChart, SalesDetailsChart), their theme-aware palettes, month dropdown filtering, and loading state.
