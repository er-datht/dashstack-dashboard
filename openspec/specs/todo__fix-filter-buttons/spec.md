# fix-todo-filter-buttons Specification

## Purpose
Defines the theme-aware, visibility-correct styling of Todo page filter buttons and the "Add Task" button, including the CSS cascade-layer override via `!text-on-primary`.
