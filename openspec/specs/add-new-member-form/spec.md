# Capability: Add New Member Form

## Purpose

Provides the Add New Member form page at `/team/add` with photo upload, 6-field form, validation, submission flow with toast and navigation, and i18n support.
