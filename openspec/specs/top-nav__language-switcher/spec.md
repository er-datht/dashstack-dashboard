...
## Purpose
Defines the LanguageSwitcher dropdown component rendered in the TopNav.

> Note: The click-based, flag-image redesign lives in the `language-dropdown` spec (see `openspec/specs/language-dropdown/spec.md`). This spec captures the original flag-emoji + hover behavior.
