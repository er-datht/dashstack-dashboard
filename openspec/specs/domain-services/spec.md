...
## Purpose
Defines the conventions for per-domain service modules: DTO→internal type transformation, mock data for development, file organization, and the deals placeholder mapping.
