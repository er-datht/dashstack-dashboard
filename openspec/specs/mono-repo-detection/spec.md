# mono-repo-detection Specification

## Purpose
Detection logic to determine if a project is a single repo or mono repo, identify individual apps/packages, and detect their routing patterns.
