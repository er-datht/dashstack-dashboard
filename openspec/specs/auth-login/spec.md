...
## Purpose
Defines the Login page UI, form logic, validation, mock submission, token storage, return-URL redirect, auto-redirect if authenticated, forgot password modal, and accessibility.
