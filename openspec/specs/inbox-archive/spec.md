# inbox-archive Specification

## Purpose

Defines the behavioral requirements for the Inbox archive feature: archiving messages, archive folder display, restore from archive, bulk archive/unarchive, archived message exclusion from source folders, and archive-related translations.
