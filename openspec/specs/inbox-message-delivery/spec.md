# inbox-message-delivery Specification

## Purpose

Defines the behavioral requirements for cross-user message delivery in the Inbox: the DeliveredMessage type, localStorage-based cross-user storage, sender identity resolution from auth, and message persistence across login sessions.
