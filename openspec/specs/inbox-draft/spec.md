# inbox-draft Specification

## Purpose

Defines the behavioral requirements for inbox draft functionality: saving, auto-saving, editing, deleting, and sending drafts, with localStorage persistence and i18n support.
