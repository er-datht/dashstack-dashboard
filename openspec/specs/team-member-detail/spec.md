# Capability: team-member-detail

## Purpose

Team member detail/edit page that displays a pre-filled PersonForm for viewing and editing an individual team member's information, with localStorage persistence for edits.
