# react-query-config Specification

## Purpose
Defines the configured TanStack React Query `queryClient` singleton, domain query hooks, and mutation hooks with optimistic updates.
