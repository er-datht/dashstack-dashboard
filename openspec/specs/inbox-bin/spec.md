# inbox-bin Specification

## Purpose

Defines the behavioral requirements for the Inbox bin (trash) folder: soft-delete to bin, restore from bin, bulk delete, bin folder display, and binned message exclusion from source folders.
